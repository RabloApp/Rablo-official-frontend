      ...
      >
        <div className="flex flex-col gap-[0.4vw]  h-[5.66vw] w-[37.53vw] mx-auto">
          ...
          <input
            ...
            name="name"
            required
            className="border-[0.05vw] rounded-tl-[0.81vw] rounded-br-[0.81vw] w-[37.53vw] h-[2.42vw]"
          />
        </div>
        <div className="flex flex-col gap-[0.4vw]  h-[5.66vw] w-[37.53vw] mx-auto">
        ...
        <div className="flex flex-col gap-[0.4vw]  h-[11.31vw] w-[37.53vw] mx-auto">
          ...
          <textarea
            ...
            name="message"
            required
            className="border-[0.05vw] rounded-tl-[0.81vw] rounded-br-[0.81vw] w-[37.53vw] h-[8.08vw]"
          ></textarea>
        </div>
        <button
          type="submit"
          className="w-[38.13vw] h-[2.83vw] p-[0.81vw] bg-[#5271FF] rounded-[0.4vw] gap-[0.51vw] font-[600] text-[1.21vw] text-[#FFFFFF] "
        >
          Send
        </button>
