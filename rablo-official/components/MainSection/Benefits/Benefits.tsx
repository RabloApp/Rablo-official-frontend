  ...
  return (
    <div id='benefits' className= 'w-full h-[41.46vw] bg-[#5271FF80] flex flex-col justify-center items-center gap-[3.5vw] relative'>
      ...
      <div className='absolute bottom-[-2vw] left-[3vw] flex flex-col z-0'>
        <Image src="/mainSection/images/circle.svg" width={0} height={0} alt='circle' className='mb-[0.5vw] w-[8.33vw] h-[8.33vw]' />
        <Image className='mt-[-2.4vw] ml-[-1.56vw] w-[6vw] h-[6vw]' src="/mainSection/images/Shapes.svg" width={0} height={0} alt='shapes' />
      </div>
