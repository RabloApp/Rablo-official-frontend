import { tutors } from "@/app/StaticData/ExploreTutors";
  ...
  return (
    <div className="flex flex-col p-[6.25vw] gap-[5vw] relative">
      <div className="flex justify-between">
        <span className="poppins-bold text-[2.5vw]">Explore Tutors...</span>
      ...
      <div className="flex gap-[4.167vw] relative">
        {tutors.map((tutor, index) => (
          <div key={index} className="w-[26.406vw] relative">
            ...
            />
            <div className="h-[20.625vw] py-[2.083vw] px-[1.25vw] bg-[#EBEFFF] mt-[6.25vw] flex flex-col gap-[2vw]">
              <p className="text-[1.667vw] poppins-semibold">{tutor.name}</p>
