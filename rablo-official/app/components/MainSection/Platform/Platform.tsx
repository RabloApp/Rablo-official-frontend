        ...
        <div className='flex flex-col justify-center items-center w-[87.5vw] mx-auto gap-[4.17vw]  py-[1.19vw] '>
          <div className='flex flex-col items-center gap-[1.25vw]'>
            <div className='flex flex-col items-center gap-[0.83vw]'>
              ...
              <p className='font-[500] text-[1.67vw]'>Recognized by StartupIndia & MSME India</p>
            </div>
              
              <p className='text-center  text-[1.67vw] mt-[20px] text-[#878686] font-[400]'>We are ready to teach Platform to help private educators and small & midsize tuition businesses grow their businesses, run their classes, and establish credibility in the market.</p>
          </div>
            ...
            <Link href="/join" className='nav-button1 '>
                Join Us Now
            </Link>
        </div>
    </div>
